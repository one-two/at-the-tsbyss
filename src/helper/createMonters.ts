...
export function CreateMonster(monster_choice: string, x: number, y: number, dungeon_level: number): Entity{
    ...
    if (monster_choice == 'fungi') {
        ...
        let fighter_component = new Fighter(50+50*qHp, 3+3*qDef, 5+5*qAtk, 60+60*qExp)
        ...
        let fighter_component = new Fighter(40+40*qHp, 3+3*qDef, 7+7*qAtk, 40+40*qExp)
        ...
        let fighter_component = new Fighter(60+60*qHp, 5+5*qDef, 7+7*qAtk, 50+50*qExp)
        ...
        let fighter_component = new Fighter(100+50*qHp, 6+6*qDef, 20+20*qAtk, 350+350*qExp)
