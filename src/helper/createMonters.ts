...
export function CreateMonster(monster_choice: string, x: number, y: number, dungeon_level: number): Entity{
    ...
    if (monster_choice == 'fungi') {
        ...
        let monster = new Entity(x, y, new Glyph('f', [0,0,0], [0, 200, 0]), 'Fungi', 1, true, 6, 2, fighter_component, ai_component);
        return monster;
    }
        ...
        let monster = new Entity(x,y, new Glyph('t', [0,0,0], [128, 0, 128]), 'Troll', 1, true, 4, 2, fighter_component, ai_component);
        return monster;
    }
        ...
        let monster = new Entity(x,y, new Glyph('w', [0,0,0], [148, 0, 211]), 'Wyvern', 1, true, 3, 2, fighter_component, ai_component);
        return monster
    }
        ...
        let monster = new Entity(x,y, new Glyph('r', [0,0,0], [233, 150, 122]), 'Ranger', 1, true, 3, 2, fighter_component, ai_component);
        return monster
    }
