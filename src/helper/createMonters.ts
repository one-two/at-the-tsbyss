...
export function CreateMonster(monster_choice: string, x: number, y: number): Entity{
    if (monster_choice == 'fungi') {
        let fighter_component = new Fighter(30, 0, 4, 35)
        ...
        let fighter_component = new Fighter(40, 0, 4, 35)
        ...
        let fighter_component = new Fighter(90, 2, 8, 60)
        ...
        let fighter_component = new Fighter(30, 0, 5, 40)
        ...
        let fighter_component = new Fighter(40, 1, 8, 40)
        ...
        let fighter_component = new Fighter(100, 5, 14, 300)
