...
export function itemProbabilities(dungeon_level: number) {
    return {
        ...
        'sword': from_dungeon_level([[2, 1], [10, 3], [5, 3]], dungeon_level),
        'spear': from_dungeon_level([[2, 1], [10, 3], [5, 3]], dungeon_level),
        'firerod': from_dungeon_level([[1, 1], [5, 3], [10, 5]], dungeon_level),
        'icerod': from_dungeon_level([[5, 3], [10, 5]], dungeon_level),
        'crossedswords': from_dungeon_level([[5, 3], [10, 5]], dungeon_level),
